...
function slider(_ref) {
  ...
  const prev = document.querySelector(prevArrow),
    ...
    // блок в которое поместим все слайды в ширину
...
const postData = async (url, data) => {
  ...
  const res = await fetch(url, {
    ...
    // только в случае отправки формата JSON
    body: data
  });
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])(".timer", "2023-01-01");
